    ...
    <div className={styles.termsContainer}>
      ...
      <div className={styles.termsContent}>
        <section className={styles.section}>
          ...
          <p>
            본 약관은 BizMatch 플랫폼(이하 "플랫폼")을 이용함에 있어 회사와
            이용자 간의 권리, 의무 및 책임사항과 기타 필요한 사항을 규정함을
            목적으로 합니다.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            1. "이용자"란 플랫폼에 접속하여 본 약관에 따라 서비스를 이용하는
            개인 또는 법인을 말합니다.
          </p>
          <p>
            2. "회원"이란 플랫폼에 가입하여 지속적으로 서비스를 이용할 수 있는
            자를 말합니다.
          </p>
          <p>
            3. "서비스"란 플랫폼에서 제공하는 중소기업 간 외주 및 협업 프로젝트
            중개, 검증 시스템, 리뷰 및 평점 기능을 포함한 모든 기능을
            의미합니다.
          </p>
        </section>
