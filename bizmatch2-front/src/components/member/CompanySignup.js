    ...
    <div className={CompanySignupStyle.signupBox}>
      ...
      <div className={CompanySignupStyle.btnBox}>
        ...
        <div>
          ...
          <button
            type="button"
            className={CompanySignupStyle.emailSubmit}
      ...
      <div className={CompanySignupStyle.btnBox}>
        <p className={CompanySignupStyle.cmpMsbBox}>
          <span className={CompanySignupStyle.redWord}>*</span>사업자 번호
        </p>
        <span className={CompanySignupStyle.cmpMsg}></span>
        <div>
          <input
            id="cmpnyBrn"
            type="text"
          ...
          />
          <button
            className={CompanySignupStyle.cmpnyBrnConfirm}
            id="cmpnyBrnConfirm"
            onClick={handleBusinessNum}
          >
            사업자 번호 확인
          </button>
        </div>
      ...
      <div className={CompanySignupStyle.textBox}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>이용자 전화번호
        </p>
        <input
          id="cmpnyNm"
          type="text"
      ...
      <div className={CompanySignupStyle.comAddr}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>기업주소
        </p>
        <div className={CompanySignupStyle.comDiv}>
          <input
            type="text"
            id="postcode"
            placeholder="우편번호 입력"
      ...
      <div className={CompanySignupStyle.textBox}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>기업 전화번호
        </p>
        <input
          id="cmpnyNm"
          type="text"
      ...
      <div className={CompanySignupStyle.btnBox}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>이용자 첨부파일
        </p>
        <div className={CompanySignupStyle.fileBox}>
          <div className={CompanySignupStyle.addfile}>
            <input
      ...
      <div className={CompanySignupStyle.textBox}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>회사 사이트 주소
        </p>
        <input
          id="cmpnyNm"
          type="text"
      ...
      <div className={CompanySignupStyle.textBox}>
        <p>
          <span className={CompanySignupStyle.redWord}>*</span>주요 산업분야
        </p>
        <CategoryBar />
      </div>
